...
def get_args():
    ...
    parser.add_argument("--num_humans", type=int, default= 20, help="number of humans")    
    # Define movement of the agents
    parser.add_argument("--action_shape", type=int, default=5, help="number of possible actions: up, down, right, and left")
    ...
    parser.add_argument("--lr-policy", type=float, default=1e-4, help="learning rate of policy")    
    ...
    parser.add_argument("--anneal_range", type=int, default=20000, help="annealing rate")    
    parser.add_argument("--gamma", type=float, default=0.95, help="discount factor")    
    parser.add_argument("--tau", type=float, default=0.0001, help="soft target update rate")    
    parser.add_argument("--update-target-frequency", type=int, default=6000, help="number of episodes to optimize at the same time")
    parser.add_argument("--wait-steps", type=int, default=5000, help="number of samples to collect before start training")
    ...
    parser.add_argument("--tensorboard-dir", type=str, default="", help="directory in which training state and model are loaded")
